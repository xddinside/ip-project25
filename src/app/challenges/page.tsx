  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 pb-16">
      ...
      <main className="container mx-auto px-6 py-12 pb-20">
        ...
        <div className="mb-20 bg-card/30 backdrop-blur-sm border border-border/50 rounded-xl p-6">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 items-start">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent leading-[1.2]">
                  Coding Challenges
                </h1>
              </div>
              <p className="text-lg text-muted-foreground max-w-[70%] leading-relaxed">
            ...
            <div className="flex flex-col gap-4 lg:items-end">
               ...
               <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 w-full lg:w-fit flex-shrink-0">
                ...
                {/* Easy Stat - Now Green */}
                <div className="group bg-card/50 backdrop-blur-sm border border-border/50 rounded-lg p-4 text-center hover:shadow-lg hover:shadow-green-500/10 hover:outline hover:outline-1 hover:outline-green-500/30 transition-all duration-300 hover:-translate-y-1 min-w-0 flex-shrink-0">
                ...
                {/* Medium Stat */}
                <div className="group bg-card/50 backdrop-blur-sm border border-border/50 rounded-lg p-4 text-center hover:shadow-lg hover:shadow-yellow-500/10 hover:outline hover:outline-1 hover:outline-yellow-500/30 transition-all duration-300 hover:-translate-y-1 min-w-0 flex-shrink-0">
                  <div className="text-2xl font-bold font-mono text-yellow-600 mb-1">
                ...
                {/* Hard Stat */}
                <div className="group bg-card/50 backdrop-blur-sm border border-border/50 rounded-lg p-4 text-center hover:shadow-lg hover:shadow-red-500/10 hover:outline hover:outline-1 hover:outline-red-500/30 transition-all duration-300 hover:-translate-y-1 min-w-0 flex-shrink-0">
                  <div className="text-2xl font-bold font-mono text-red-600 mb-1">
                ...
                {/* Progress Stat */}
                <div className="group bg-card/50 backdrop-blur-sm border border-border/50 rounded-lg p-4 text-center hover:shadow-lg hover:shadow-purple-500/10 hover:outline hover:outline-1 hover:outline-purple-500/30 transition-all duration-300 hover:-translate-y-1 min-w-0 flex-shrink-0">
